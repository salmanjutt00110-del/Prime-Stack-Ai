      ...
      <main id="main-content" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-400">
            Have questions before ordering or need warranty support? Reach out directly â€” we respond within minutes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="p-6 rounded-2xl bg-[#0c0d12] border border-white/10 text-center">
            ...
            <p className="text-xs text-purple-300 font-semibold mb-2">9:00 AM â€“ 11:00 PM (PKT)</p>
            <p className="text-xs text-slate-400">7 Days a Week â€¢ Full Warranty Assistance</p>
          </div>
