...
export default function StatsBar() {
  ...
  const STATS = [
    { icon: Package, value: 30, suffix: "+", label: "Premium Products" },
    { icon: Users, value: 15000, suffix: "+", label: "Happy Clients" },
    { icon: Headphones, value: 24, suffix: "/7", label: "Support Active" },
    { icon: Zap, value: 100, suffix: "%", label: "100% Replacement Warranty" },
  ];
  ...
  return (
    <section className="relative py-10 px-4 sm:px-6">
      <div
        ref={ref}
        className="mx-auto max-w-5xl rounded-2xl px-6 py-8 flex flex-wrap items-center justify-center gap-y-6 ps-luxury-glass border border-white/10 shadow-lg"
      >
        {STATS.map((s, i) => (
          <div
            key={i}
          ...
          >
            ...
            <s.icon className="text-violet-400 mb-2" size={22} />
