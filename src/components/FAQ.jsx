  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderColor: open ? "rgba(139,92,246,0.35)" : "rgba(255,255,255,0.07)",
        boxShadow: open ? "0 10px 30px rgba(139,92,246,0.1)" : "none",
      }}
    ...
    >
      ...
      >
        ...
        <span
          className="shrink-0 p-1.5 rounded-lg text-white/70 transition-transform duration-300"
          style={{ background: open ? "rgba(139,92,246,0.2)" : "rgba(255,255,255,0.05)" }}
        >
        ...
        {open && (
          ...
          >
            <div className="px-6 pb-5 border-t border-white/5 pt-3">
              <p className="text-white/65 text-sm sm:text-base leading-relaxed font-body">
                {item.a}
              </p>
              <div className="mt-3 flex items-center justify-between">
                <span className="text-[11px] font-mono text-violet-400/70 uppercase tracking-wider">
    ...
    <section id="faq" className="relative py-24 px-4 sm:px-6 scroll-mt-24">
      ...
      <div className="mx-auto max-w-4xl relative z-10">
        <div className="text-center mb-12">
          <motion.div
            className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-bold text-violet-400 uppercase tracking-widest bg-violet-500/10 border border-violet-500/20 mb-3"
