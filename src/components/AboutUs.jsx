      ...
      <div className="mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch mb-16">
          ...
          >
            ...
            <div>
              ...
              <div className="mt-5 space-y-4 text-white/80 text-sm sm:text-base leading-relaxed font-body">
                <p>
            ...
            {/* Bullet Highlights */}
            <div className="mt-8 pt-6 border-t border-white/10 grid sm:grid-cols-2 gap-3 text-xs sm:text-sm font-semibold text-white/90">
              ...
              >
                <div>
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${p.color}25, rgba(139,92,246,0.15))`,
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {STATS.map((s, i) => (
            ...
            >
              <div
                className="w-10 h-10 mx-auto mb-2 rounded-lg flex items-center justify-center opacity-90"
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(139,92,246,0.15), rgba(59,130,246,0.12), rgba(236,72,153,0.1))",
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-semibold text-white transition-all duration-300 hover:scale-[1.03] min-h-[44px]"
              style={{
