  ...
  return (
    <section className="relative py-12 px-4 sm:px-6">
      ...
      <div className="mx-auto max-w-4xl relative z-10">
        {/* Outer animated gradient border card */}
        <motion.div
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(180deg, rgba(10, 15, 13, 0.95) 0%, rgba(5, 7, 6, 0.98) 100%)",
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
              <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 text-xs font-bold tracking-wide uppercase">
            ...
            <div className="text-left mb-8">
              ...
              <p className="mt-2 text-white/70 text-sm sm:text-base leading-relaxed">
                Choose your preferred warranty duration and enjoy instant activation with guaranteed support on <span className="text-emerald-400 font-semibold">Prime Tools Hub</span>.
              </p>
            </div>
                ...
                return (
                  <motion.div
                    ...
                    className={`relative rounded-2xl p-5 sm:p-6 cursor-pointer border transition-all duration-300 flex flex-col justify-between ${
                      isSelected
                        ? "bg-emerald-950/40 border-emerald-500/80 shadow-[0_0_30px_rgba(16,163,127,0.35)]"
                        : "bg-white/[0.03] border-white/10 hover:border-white/25 hover:bg-white/[0.05]"
                    }`}
                  >
                    {/* Popular badge */}
                    {opt.popular && (
                      <span className="absolute -top-3 right-4 bg-gradient-to-r from-emerald-500 to-teal-400 text-black font-extrabold text-[10px] uppercase tracking-wider px-3 py-1 rounded-full shadow-md">
                        {opt.tag}
                      </span>
                    )}

                    {!opt.popular && (
                      <span className="absolute -top-3 right-4 bg-white/10 border border-white/15 text-white/80 font-bold text-[10px] uppercase tracking-wider px-2.5 py-0.5 rounded-full">
                        {opt.tag}
                      </span>
                    )}
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/60 leading-relaxed mb-4">{opt.desc}</p>
                    </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-white/10">
              <div className="text-xs text-white/65 text-center sm:text-left">
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-2xl font-display font-extrabold text-sm text-black flex items-center justify-center gap-2.5 transition-all duration-300 hover:scale-[1.03] shadow-[0_0_25px_rgba(37,211,102,0.4)] cursor-pointer"
                style={{
