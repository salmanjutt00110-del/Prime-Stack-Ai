...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-16 pb-8 px-4 sm:px-6 border-t border-white/8">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center text-center gap-5">
          ...
          <p className="text-white/75 text-sm max-w-md font-body">
            Premium AI Tools & Digital Services — Available on{" "}
            <span className="text-white font-semibold">PrimeTools.store</span>. Powering the
        ...
        <div className="mt-10 p-5 sm:p-6 rounded-2xl border border-amber-500/25 bg-white/[0.02] backdrop-blur-md max-w-3xl mx-auto text-left relative overflow-hidden group hover:border-amber-500/40 transition-all duration-300">
          ...
          <p className="text-white/90 text-xs sm:text-[13px] leading-relaxed font-medium mb-3">
          ...
          <p className="text-white/70 text-xs sm:text-[12px] leading-relaxed font-normal border-t border-white/8 pt-2.5">
        ...
        <div className="mt-10 pt-6 border-t border-white/8 text-center">
          <p className="text-white/65 text-xs font-semibold">
            © {new Date().getFullYear()} Prime Tools Hub (<span className="text-white/85">PrimeTools.store</span>). All rights reserved.
          </p>
        </div>
      </div>
    </footer>
