...
export const HERO_PRODUCTS = [
  ...
  { id: "youtube-premium-12m", name: "YouTube Premium", tag: "📺 Fixed Family Slot", duration: "12 Months", price: "Rs. 8,700", oldPrice: "Rs. 9,999", description: "12 Months of stable YouTube Premium and YouTube Music access on your personal Google account via a fixed family slot.", logo: BRAND.youtube, color: "#FF0000", color2: "#cc0000", particle: "#FF0000" },
  { id: "chatgpt-go-3m", name: "ChatGPT Go", tag: "🎫 Coupon Code", duration: "3 Months", price: "Rs. 899", oldPrice: "Rs. 1,199", description: "ChatGPT Go subscription for 3 months. Fast delivery via coupon code. Stable service with easy activation.", logo: BRAND.chatgptGo, color: "#10A37F", color2: "#0D8A6D", particle: "#10A37F" },
  { id: "capcut-pro-admin-7s", name: "CapCut Pro Admin Team", tag: "👑 Admin Team · 7 Seats", duration: "1 Month", price: "Rs. 4,999", oldPrice: "Rs. 5,499", description: "1 Month of CapCut Pro admin team account with 7 seats. Full premium editing and AI tools included.", logo: BRAND.capcut, color: "#FE2C55", color2: "#25F4EE", particle: "#FE2C55" },
  { id: "surfshark-vpn-1m", name: "Surfshark VPN", tag: "🛡️ Single Device", duration: "1 Month", price: "Rs. 399", oldPrice: "Rs. 499", description: "1 Month of Surfshark VPN premium access. Fast & secure browsing with global servers on a single device.", logo: BRAND.surfshark, color: "#1C9FE8", color2: "#22D3EE", particle: "#22D3EE" },
  { id: "nordvpn-3m", name: "NordVPN", tag: "🛡️ Redeem Link", duration: "3 Months", price: "Rs. 999", oldPrice: "Rs. 1,299", description: "3 Months NordVPN premium subscription via easy activation redeem link. High-speed global servers, secure and private.", logo: BRAND.nord, color: "#0060FF", color2: "#8B5CF6", particle: "#60A5FA" },
  { id: "lovable-ai-100c", name: "Lovable AI Pro", tag: "💎 100 Credits", duration: "1 Month", price: "Rs. 1,199", oldPrice: "Rs. 1,499", description: "Lovable AI Pro with 100 credits for 1 month. Fast and reliable premium AI generation access with 1 day warranty.", logo: BRAND.lovable, color: "#EE0F79", color2: "#8B5CF6", particle: "#A78BFA" },
];
