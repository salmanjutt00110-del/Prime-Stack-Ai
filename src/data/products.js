...
export const ALL_PRODUCTS = [
  ...
  },
  {
    ...
    description: "SuperGrok premium access for 1 month — advanced AI models and fast responses, powered by X.",
    features: ["SuperGrok Premium Access", "1 Month Subscription", "Advanced AI Models", "Fast Responses", "Premium AI Features", "Stable Account"],
    whatsIncluded: ["SuperGrok Premium Access", "1 Month Subscription", "Advanced AI Models", "Fast Responses", "Email", "Password"],
    requirements: ["Log in immediately and verify the account after delivery"],
    termsOfUse: ["Do NOT change the email address", "Do NOT unlink the X account", "You may change the Grok account password"],
    warrantyPolicy: ["No warranty is provided", "Please log in and verify the account immediately after receiving it", "Activation guidance and support will be provided"],
    warrantyNote: "No Warranty",
  },
  {
    ...
    features: ["SuperGrok Premium Access", "3 Months Subscription", "Advanced AI Models", "Fast Responses", "Premium AI Features", "Stable Account"],
    whatsIncluded: ["SuperGrok Premium Access", "3 Months Subscription", "Advanced AI Models", "Fast Responses", "Email", "Password"],
    requirements: ["Log in immediately and verify the account after delivery"],
    termsOfUse: ["Do NOT change the email address", "Do NOT unlink the X account", "You may change the Grok account password"],
    warrantyPolicy: ["No warranty is provided", "Please log in and verify the account immediately after receiving it", "Activation guidance and support will be provided"],
    warrantyNote: "No Warranty",
  },
  {
    ...
    logo: BRAND.grok,
    tag: "⚡ 6 Months",
    tagline: "6-Month SuperGrok subscription powered by X.",
    description: "SuperGrok premium access for 6 months — advanced AI models and fast responses, powered by X.",
    features: ["SuperGrok Premium Access", "6 Months Subscription", "Advanced AI Models", "Fast Responses", "Premium AI Features", "Stable Account"],
    whatsIncluded: ["SuperGrok Premium Access", "6 Months Subscription", "Advanced AI Models", "Fast Responses", "Email", "Password"],
    requirements: ["Log in immediately and verify the account after delivery"],
    termsOfUse: ["Do NOT change the email address", "Do NOT unlink the X account", "You may change the Grok account password"],
    warrantyPolicy: ["No warranty is provided", "Please log in and verify the account immediately after receiving it", "Activation guidance and support will be provided"],
    warrantyNote: "No Warranty",
  },
  {
    ...
    whatsIncluded: ["SuperGrok Premium Access", "12 Months Subscription", "Email", "Password"],
    requirements: ["Log in and verify the account immediately after receiving it"],
    termsOfUse: ["Do NOT change the email address", "Do NOT unlink/disconnect the X (Twitter) account", "You may change the account password"],
    warrantyPolicy: ["No warranty is provided", "Please log in and verify the account immediately after receiving it", "Activation guidance and support will be provided"],
    warrantyNote: "No Warranty",
  },
  {
