...
export const HERO_PRODUCTS = [
  ...
  { id: "chatgpt-plus-1m", name: "ChatGPT Plus Premium", tag: "💎 1 Month Warranty", duration: "1 Month Warranty", price: "Rs. 2,199", oldPrice: "Rs. 2,699", description: "ChatGPT Plus Premium subscription with 1 Month full replacement warranty. Instant delivery & 2FA setup included.", tagline: "Full official ChatGPT Plus access with 1 Month Warranty included.", stock: "5", logo: BRAND.chatgpt, color: "#10A37F", color2: "#0D8A6D", particle: "#10A37F" },
...
export const ALL_PRODUCTS = [
  ...
  {
    id: "chatgpt-plus-10d",
    name: "ChatGPT Plus (10 Days Warranty)",
    duration: "10 Days Warranty",
    price: "Rs. 1,599",
    oldPrice: "Rs. 1,999",
    stock: "8",
    color: "#10A37F",
    logo: BRAND.chatgpt,
    tag: "⚡ 10 Days Warranty",
    tagline: "Official ChatGPT Plus access with 10 Days replacement warranty.",
    description: "ChatGPT Plus subscription with 10 Days replacement warranty. Fast delivery & full GPT-4o access.",
    features: ["ChatGPT Plus Subscription", "10 Days Replacement Warranty", "Full Premium Access (GPT-4o)", "Instant Delivery", "2FA Code Setup Included"],
    whatsIncluded: ["ChatGPT Plus Access", "Email & Password", "2FA Code Setup", "10 Days Replacement Warranty"],
    requirements: ["Log in at https://2fa.live using the 2FA secret we provide"],
    termsOfUse: ["Check and log in to your account immediately after receiving it"],
